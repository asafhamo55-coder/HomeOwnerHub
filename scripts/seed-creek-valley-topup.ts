...
async function seedAiRuns(db: Db): Promise<void> {
  ...
  const runs = [
    { workflow: 'covenant_brain', when: '2025-03-12T14:22:00Z', q: 'Can residents paint their fence without ARC approval?', a: 'Per CC&R §3.4, fences require ARC approval for height (max 6\') and material. Repainting the fence in a non-approved color is a §3.5 violation; the approved palette is on file with the management office.', conf: 0.94 },
    { workflow: 'covenant_brain', when: '2025-04-08T19:15:00Z', q: 'What are quiet hours?', a: 'Per CC&R §6.1, quiet hours are 10:00 PM through 7:00 AM daily, with extended exceptions on New Year\'s Eve and Independence Day. Amplified sound is restricted at the property line during these hours.', conf: 0.98 },
    { workflow: 'covenant_brain', when: '2025-05-14T16:45:00Z', q: 'How many pets am I allowed?', a: 'Per CC&R §5.3, you may keep up to three dogs and three cats, or any combination not exceeding four total domestic pets weighing over ten pounds. Livestock, poultry, and exotic animals are prohibited.', conf: 0.97 },
    { workflow: 'covenant_brain', when: '2025-06-11T11:30:00Z', q: 'Are short-term rentals allowed?', a: 'No. Per CC&R §5.5, no lot or residence may be leased for a term of less than 180 consecutive days. Use as a vacation rental through Airbnb, Vrbo, or similar platforms is expressly prohibited. Violations may incur fines up to $500/day.', conf: 0.99 },
    { workflow: 'covenant_brain', when: '2025-07-22T20:01:00Z', q: 'Can I install a satellite dish?', a: 'Yes, subject to FCC OTARD Rule (47 C.F.R. §1.4000). Per CC&R §3.8, dishes one meter or less are permitted; the ARC strongly encourages but cannot require rear-roof or rear-yard placement.', conf: 0.96 },
    { workflow: 'violation_drafter', when: '2025-05-22T14:08:00Z', q: 'Fence at 14 Creek Valley Dr — material non-conforming', a: '[Drafted full notice citing §3.2 with 30-day cure deadline]', conf: 0.92, status: 'approved' },
    { workflow: 'violation_drafter', when: '2025-06-05T13:18:00Z', q: 'Lawn overgrown at 47 Creek Valley Dr', a: '[Drafted courtesy notice citing §4.1, 14-day cure]', conf: 0.95, status: 'approved' },
    { workflow: 'violation_drafter', when: '2025-09-09T10:55:00Z', q: 'Noise complaints — 34 Creek Valley Dr', a: '[Drafted §6.1 notice with $75 first-offense fine]', conf: 0.89, status: 'approved' },
    ...
    { workflow: 'covenant_brain', when: '2025-11-03T15:20:00Z', q: 'Holiday decoration rules — when do they have to come down?', a: 'Per the Nov 2025 board update to §4.3 (effective Nov 25): winter holiday decor must be removed by January 15. Other seasonal decor: no later than 14 days after the holiday.', conf: 0.93 },
    { workflow: 'covenant_brain', when: '2025-12-08T09:42:00Z', q: 'Can I park my work van in the driveway?', a: 'Per CC&R §5.1, commercial vehicles with signage may not be regularly parked in driveways visible from the street between 6PM–7AM. Ladder racks count as signage.', conf: 0.91 },
    { workflow: 'arc_recommender', when: '2025-08-26T17:00:00Z', q: 'ARC packet for deck addition at 415 Park Ln', a: '[Drafted ARC recommendation: approve with conditions on stain color and rear setback per §3.6]', conf: 0.88, status: 'approved' },
    ...
    { workflow: 'violation_drafter', when: '2026-04-22T13:08:00Z', q: 'Boat parked at 52 Creek Valley Dr — sidewalk obstruction', a: '[Drafted §5.3 notice with $75 fine, 14-day cure]', conf: 0.90, status: 'approved' },
